...
function Footer() {
  return (
      <div className='w-full h-full bg-gray-400 text-black px-10 py-16 flex gap-10'>
      ...
      <div className='details mt-10 '>
        ...
        <h1 className='font-semibold mt-50 mb-5 text-xl'>L:</h1>       
        ...
        <h1 className='font-semibold mt-50 mb-5 text-xl'>E:</h1>       
